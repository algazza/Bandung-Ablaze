...
import ilustrasi1 from "../img/ilustrasiBandung1.jpeg";
import ilustrasi2 from "../img/ilustrasiBandung2.jpeg";
import ilustrasi3 from "../img/ilustrasiBandung3.jpeg";
...
export const styles = {
  ...
  heading6:
    "font-bold xs:text-[20px] text-[16.8px] leading-[24px] xs:leading-[28px] ",
